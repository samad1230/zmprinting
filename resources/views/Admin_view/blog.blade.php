...
<div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="float: right;">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#blog_modal"><i class="zmdi zmdi-plus"></i>Add Blog</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="305px">
                                                    <button type="button" class="btn btn-primary btn-sm edit_blog_btn" id="{{$row->id}}" >Edit</button>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('blog.delete',$row->id)}}" role="button">Delete</a>
                                                </td>
                                            </tr>
                                             @endforeach
                                        </tbody>
    ...
    <div class="modal fade" id="blog_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="">Add blog</h4>
                ...
                <div class="modal-body">
                     @if ($errors->any())
                      ...
                      @endif
                    <form action="{{ url('blog') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf

                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class=" " for="name">Blog Title</label>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class=" " for="name">Blog Image</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="file" name="image" class="form-control" id="" placeholder="Blog Image" >
                                </div>
                            </div>
                        </div>
